...
import static com.fixadate.global.util.constant.ConstantValue.AES_ALGORITHM;
import static com.fixadate.global.util.constant.ConstantValue.CIPHER_INSTANCE;
...
public class AesUtil {
    ...
    public static String aesCBCEncode(String plainText) throws NoSuchPaddingException, NoSuchAlgorithmException,
            ...
            BadPaddingException {
        SecretKeySpec secretKey = new SecretKeySpec(privateKey_256.getBytes(StandardCharsets.UTF_8), AES_ALGORITHM.getValue());
