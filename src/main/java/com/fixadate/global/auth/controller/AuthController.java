...
public interface AuthController {
    ...
    @Operation(summary = "회원 등록", description = "OAuth 대조를 통해 로그인을 합니다.")
    ...
    ResponseEntity<Void> registMember(@Valid MemberOAuthRequest memberOAuthRequest);
    ...
    ResponseEntity<String> AdditionalRegistMember(@Valid MemberRegistRequest memberRegistRequest);
}
