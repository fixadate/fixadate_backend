...
public interface GoogleCalendarController {
    ...
    ResponseEntity<List<GoogleCalendarEventResponse>> getGoogleCalendarEvents(String accessToken, GoogleCalendarTimeRequest timeRequest, HttpServletRequest httpServletRequest);
